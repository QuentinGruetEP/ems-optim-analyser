...
execute CPX_PARAM {
	...
	if (operationID == "1529" || operationID == "1628" || operationID == "1661")
		microgridName = "MICROGRID GP Brielle";
	if (operationID == "1663"|| operationID == "2004" || operationID == "2005")
		microgridName = "MICROGRID GP Vierpolders";
...
//	forall (t in isDECISION_STEPS)
	...
	forall ( t in isDECISION_STEPS : ord(isDECISION_STEPS, t)>=9 && ord(isDECISION_STEPS, t)<=11)

		ctTest : DispGenEffActivePower[first(isDISP_E_GENS)][t] == 1093;
