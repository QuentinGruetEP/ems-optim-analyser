...
float negative_imb_price[imb in isIMBALANCE_STEPS_POS] =
		(microgridName == "Equans BIC microgrid" ? 				// If Equans : we are not exposed to imabalance.
			...
			:(microgridName == "MICROGRID MOPABLOEM" || microgridName == "MICROGRID GP Brielle" || microgridName == "MICROGRID GP Vierpolders" || microgridName == "MICROGRID VERBERNE America" // if C&I in NL
...
//forall ( s in isH_STORAGES, t in isDECISION_STEPS : ord(isDECISION_STEPS, t)>=21 && ord(isDECISION_STEPS, t)<=24)

//	ctTest : StorHeatExchange[s][t] == -1698;


forall (t in isDECISION_STEPS : ord(isDECISION_STEPS, t)>=5 && ord(isDECISION_STEPS, t)<=9)

	ctTest : ConvActivePowerIn["GP_VIERPOLDERS_EBOILER"][t] == 0;
...
string operationStepsExcelRange = "'OPERATION_STEPS'!A2:F";
...
string assetsExcelRange = "'ASSETS'!A2:F";
...
string assetStepsExcelRange = "'ASSET_STEPS'!A2:K";
...
string violationExcelRange = "'VIOLATIONS'!A2:F";
...
string marketBidsExcelRange = "'MARKET_BIDS'!A2:F";
