/*********************************************
 * Microgrid Optimisation Model v4.0.46
 * Author: j.leduc
...
{t_assets} H_ASSETS = (
	...
	? ASSETS inter {a | a in ASSETS:
		...
		a.asset_id == "Verberne_America_Heatpump_3" ||
		a.asset_id == "Verberne_America_Heatpump_4" ||
		a.asset_id == "Verberne_America_Gasboiler1"
		}
	: microgridName == "MICROGRID VAN DEN BERG EST"
	? ASSETS inter { a | a in ASSETS: 
	a.asset_id == "Van_Den_Berg_Est_CHP1" ||
	...
	? ASSETS inter {a | a in ASSETS:
		...
		a.asset_id == "Verberne_Melderslo_Gasboiler1"
		}
	: {}
	);
...
execute CPX_PARAM {
	...
	if (operationID == "1663")
		microgridName = "MICROGRID GP Vierpolders";
	if (operationID == "1597" || operationID == "1566") // rajouter ici le nouvel id d'opé ugrid pour America avec procurement spot + mFRR quand créé
		microgridName = "MICROGRID VERBERNE America";
	if (operationID == "1727" )
		microgridName = "MICROGRID VAN DEN BERG EST";
	if (operationID == "1801")
		microgridName = "MICROGRID VERBERNE Melderslo";
	if (operationID == "1826" || operationID == "1826_FAT")
...
// For Topjoynt and Weyers, during DA bidding over non-cleared steps, we prevent BESS to be used
forall (s in isE_STORAGES, t in isDECISION_STEPS : isDAStepCleared[assetStepHourlyStep[t]] == 0 && microgridName in {"MICROGRID Topjoynt", "MICROGRID Weyers"}  && optContext == "MARKET_STRAT_DA")
