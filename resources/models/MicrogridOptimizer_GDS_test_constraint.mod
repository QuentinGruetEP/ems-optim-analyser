...
// Test constraint to force the battery power
//	forall (s in isE_STORAGES, t in isDECISION_STEPS)
	forall (s in isE_STORAGES, t in isDECISION_STEPS : 19 <= ord(isDECISION_STEPS,t) <= 26)
	  ctTestPower: StorACActivePower[s][t] == -1000;
