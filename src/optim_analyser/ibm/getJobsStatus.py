...
class getJobsStatus:
    ...
    def funGetJobState(
        self, jobID: Optional[str] = None, accessToken: Optional[str] = None, jobResponseData: Optional[dict] = None
    ) -> Optional[str]:
        ...
        try:
            if jobID is not None and jobResponseData is not None:
                ...
                ).funGetJobData(jobID, "state", accessToken)
    ...
    def isQueued(
        self, jobID: Optional[str] = None, jobState: Optional[str] = None, accessToken: Optional[str] = None
    ) -> Optional[bool]:
    ...
    def isFinished(
        ...
        return self.isState(
            expectedStates=["completed", "canceled", "failed"], jobID=jobID, jobState=jobState, accessToken=accessToken
        )

    # Jobs Status

    def funIsAllLaunchedJobsState(
        self,
        isState: Callable,
        jobIDs: Optional[list] = None,
        jobStates: Optional[list] = None,
        accessToken: Optional[str] = None,
    ) -> Optional[Union[bool, tuple[bool, bool]]]:
        if jobIDs is not None and jobStates is None:
            ...
            return (
                all([isState(jobID=jobID, accessToken=accessToken) for jobID in jobIDs]),
                all([isState(jobState=jobState) for jobState in jobStates]),
            )
        else:
            return None

    def funIsAllLaunchedJobsFinished(
        self, jobIDs: Optional[list] = None, jobStates: Optional[list] = None, accessToken: Optional[str] = None
    ) -> Optional[Union[bool, tuple[bool, bool]]]:
        return self.funIsAllLaunchedJobsState(self.isFinished, jobIDs, jobStates, accessToken)

    def funIsAllLaunchedJobsCompleted(
        self, jobIDs: Optional[list] = None, jobStates: Optional[list] = None, accessToken: Optional[str] = None
    ) -> Optional[Union[bool, tuple[bool, bool]]]:
