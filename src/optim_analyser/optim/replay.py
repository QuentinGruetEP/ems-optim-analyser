...
def replay_optimization(model_path:str, dat_path:str, data:dict[str,pd.DataFrame], excel_output_path:str) -> None :
    ...
    optimiser_objective_value_init = data['OPERATION_OUTPUT'].set_index('param_id').transpose()['optimiser_objective_value']['param_val']
    ...
    optimiser_objective_value_recomputed = output_data['OPERATION_OUTPUT'].set_index('param_id').transpose()['optimiser_objective_value']['param_val']
