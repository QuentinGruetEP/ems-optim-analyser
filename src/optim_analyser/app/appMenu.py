...
class Menu(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.button_display = ttk.Button(
            self.frame_button,
            text="Run optimization and display optimization results",
        ...
        self.button_compare = ttk.Button(
            self.frame_button, text="Compare optimizations", command=lambda: controller.show_frame(Comparison)
        )
        self.button_compare.grid(column=0, row=1, pady=5)

        self.button_force_behavior = ttk.Button(
            self.frame_button, text="Force bevahior", command=lambda: controller.show_frame(ForceBehavior)
        )
